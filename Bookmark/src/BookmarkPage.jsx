...
const BookmarkPage = () => {
  ...
  return (
    <div>
      <header>
        <img
          src="./src/images/logo-bookmark.svg"
          alt="bookmark-logo"
          id="logo"
        />
        { (isMobile&&isNavOpen) && (<nav>
          <ul>
            <div className="mobile-nav-container">
            <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg" id="mobile-logo">
            ...
            <img src="./src/images/icon-close.svg" alt="close-button" onClick={() => setIsNavOpen(false)} />
          ...
          <div className="media" id="modal-icons"  hidden>
        ...
        <img src="./src/images/icon-hamburger.svg" alt="hamburger" id="menu" onClick={()=> setIsNavOpen(!isNavOpen)}/>
      </header>
      <section className="main">
        <div className="text-container">
          ...
          <button id="chrome-button">Get it on chrome</button>
          <button id="firefox-button">Get it on firefox</button>
          </div>
        </div>
        <div className="bg-hero">
          <img src="./src/images/illustration-hero.svg" alt="bg-hero" />

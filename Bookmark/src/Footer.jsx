...
const Footer = () => {
  ...
  return (
    <footer>
      <p id="number-joined">35,000+ already joined</p>
      ...
      <div className="inputForm">
        ...
        <input
          ...
          ref={inputFocus}
        />
        {check===false && (<img src="./src/images/icon-error.svg" className="error-icon"/>)}
        {check ===false && (<div className="error-message">
            <p>Whoops, make sure it's a valid email</p>
        </div>)}
        </div>
        <button onClick={() => checkEmail(inputFocus.current.value)}>Contact Us</button>
      </div>
      <aside>
